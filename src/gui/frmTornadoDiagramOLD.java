 ...
 *
 */
public class frmTornadoDiagramOLD {
	...
	public frmTornadoDiagramOLD(AmuaModel model){
		this.myModel=model;
	...
	private void initialize() {
		try{
			...
			frmTornadoDiagram.setIconImage(Toolkit.getDefaultToolkit().getImage(frmTornadoDiagramOLD.class.getResource("/images/tornado.png")));
